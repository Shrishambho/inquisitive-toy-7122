		...
		try {
			...
			for(Customer ct: list) {
				if(ct.getIsDeleted()==0) {
					System.out.println("Customer ID:- "+ct.getId()+" Name :-"+ct.getName()+" username:-"+ct.getUsername()
					+" password:-"+ct.getPassword()+" city:-"+ct.getAddress().getCity()+" state:- "+ct.getAddress().getState()+" zipcode:-"+ct.getAddress().getZipcode());
				}else {
					System.out.println("Customer ID:- "+ct.getId()+" Name :-"+ct.getName()+" username:-"+ct.getUsername()
					+" password:-"+ct.getPassword()+" city:-"+ct.getAddress().getCity()+" state:- "+ct.getAddress().getState()+" zipcode:-"+ct.getAddress().getZipcode()+"customer deleted their account.");
				}
			}
